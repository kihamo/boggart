...
func localesRuLc_messagesBoggartMo() (*asset, error) {
	...
	info := bindataFileInfo{name: "locales/ru/LC_MESSAGES/boggart.mo", size: 711, mode: os.FileMode(420), modTime: time.Unix(1531123500, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func localesRuLc_messagesDevicesMo() (*asset, error) {
	...
	info := bindataFileInfo{name: "locales/ru/LC_MESSAGES/devices.mo", size: 1052, mode: os.FileMode(420), modTime: time.Unix(1531123500, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
