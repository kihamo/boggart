...
func templatesViewsDevicesHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/views/devices.html", size: 2675, mode: os.FileMode(420), modTime: time.Unix(1543260338, 0)}
...
func assetsJsDevicesJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/js/devices.js", size: 6130, mode: os.FileMode(420), modTime: time.Unix(1543439985, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func localesRuLc_messagesBoggartMo() (*asset, error) {
	...
	info := bindataFileInfo{name: "locales/ru/LC_MESSAGES/boggart.mo", size: 476, mode: os.FileMode(420), modTime: time.Unix(1543879909, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func localesRuLc_messagesDevicesMo() (*asset, error) {
	...
	info := bindataFileInfo{name: "locales/ru/LC_MESSAGES/devices.mo", size: 1052, mode: os.FileMode(420), modTime: time.Unix(1543879909, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
