...
var (
	...
	metricSwitchValue           = snitch.NewGauge("switch_value", "Export metric esphome_switch_value")
	metricSwitchFailed          = snitch.NewGauge("switch_failed", "Export metric esphome_switch_failed")
