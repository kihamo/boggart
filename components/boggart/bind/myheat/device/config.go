...
type Config struct {
	...
	TopicHeaterHeatingFeedTemperature   mqtt.Topic    `mapstructure:"topic_heater_heating_feed_temperature" yaml:"topic_heater_heating_feed_temperature"`
	TopicHeaterHeatingReturnTemperature mqtt.Topic    `mapstructure:"topic_heater_heating_return_temperature" yaml:"topic_heater_heating_return_temperature"`
...
func (t Type) ConfigDefaults() interface{} {
	...
	return &Config{
		...
		TopicHeaterHeatingFeedTemperature:   prefix + "heater/+/heating/feed-temperature",
		TopicHeaterHeatingReturnTemperature: prefix + "heater/+/heating/return-temperature",
