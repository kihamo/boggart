...
func (b *Bind) taskUpdater(ctx context.Context) error {
	...
	if current, err := b.provider.TemperatureIn(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicTemperatureIn, current); err != nil {
	...
	if current, err := b.provider.TemperatureOut(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicTemperatureOut, current); err != nil {
			result = multierr.Append(result, err)
		}
	} else {
		result = multierr.Append(result, err)
	...
	if current, err := b.provider.TemperatureDelta(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicTemperatureDelta, current); err != nil {
			result = multierr.Append(result, err)
		}
	} else {
		result = multierr.Append(result, err)
	...
	if current, err := b.provider.Energy(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicEnergy, current); err != nil {
			result = multierr.Append(result, err)
		}
	} else {
		result = multierr.Append(result, err)
	...
	if current, err := b.provider.Consumption(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicConsumption, current); err != nil {
			result = multierr.Append(result, err)
		}
	} else {
		result = multierr.Append(result, err)
	...
	if current, err := b.provider.Capacity(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicCapacity, current); err != nil {
			result = multierr.Append(result, err)
		}
	} else {
		result = multierr.Append(result, err)
	...
	if current, err := b.provider.Power(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicPower, current); err != nil {
			result = multierr.Append(result, err)
		}
	} else {
		result = multierr.Append(result, err)
	...
	if current, err := b.provider.PulseInput1(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicInputPulses1, current); err != nil {
			result = multierr.Append(result, err)
		}
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicInputVolume1, volume); err != nil {
			result = multierr.Append(result, err)
		}
	} else {
		result = multierr.Append(result, err)
	...
	if current, err := b.provider.PulseInput2(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicInputPulses2, current); err != nil {
			result = multierr.Append(result, err)
		}
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicInputVolume2, volume); err != nil {
			result = multierr.Append(result, err)
		}
	} else {
		result = multierr.Append(result, err)
	...
	if current, err := b.provider.PulseInput3(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicInputPulses3, current); err != nil {
			result = multierr.Append(result, err)
		}
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicInputVolume3, volume); err != nil {
			result = multierr.Append(result, err)
		}
	} else {
		result = multierr.Append(result, err)
	...
	if current, err := b.provider.PulseInput4(); err == nil {
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicInputPulses4, current); err != nil {
			result = multierr.Append(result, err)
		}
		...
		if err := b.MQTTContainer().PublishAsync(ctx, b.config.TopicInputVolume4, volume); err != nil {
			result = multierr.Append(result, err)
		}
	} else {
		result = multierr.Append(result, err)
