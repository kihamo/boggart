...
type Config struct {
	...
	TopicSMSLast                         mqtt.Topic    `mapstructure:"topic_sms_last" yaml:"topic_sms_last"`
	...
	TopicMobileCurrentConnectionDuration mqtt.Topic    `mapstructure:"topic_mobile_current_connection_duration" yaml:"topic_mobile_current_connection_duration"`
	TopicMobileCurrentDownload           mqtt.Topic    `mapstructure:"topic_mobile_current_download" yaml:"topic_mobile_current_download"`
	TopicMobileCurrentUpload             mqtt.Topic    `mapstructure:"topic_mobile_current_upload" yaml:"topic_mobile_current_upload"`
	TopicMobileTotalConnectionDuration   mqtt.Topic    `mapstructure:"topic_mobile_total_connection_duration" yaml:"topic_mobile_total_connection_duration"`
	TopicMobileTotalDownload             mqtt.Topic    `mapstructure:"topic_mobile_total_download" yaml:"topic_mobile_total_download"`
	TopicMobileTotalUpload               mqtt.Topic    `mapstructure:"topic_mobile_total_upload" yaml:"topic_mobile_total_upload"`
}
...
func (t Type) ConfigDefaults() interface{} {
	...
	return &Config{
		...
		TopicMobileCurrentConnectionDuration: prefix + "connection/mobile/duration",
		TopicMobileCurrentDownload:           prefix + "connection/mobile/download",
		TopicMobileCurrentUpload:             prefix + "connection/mobile/upload",
		TopicMobileTotalConnectionDuration:   prefix + "connection/mobile/duration/total",
		TopicMobileTotalDownload:             prefix + "connection/mobile/download/total",
		TopicMobileTotalUpload:               prefix + "connection/mobile/upload/total",
	}
}
