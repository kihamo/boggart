...
local WIFI_SSID = "shosho_home"
local WIFI_PASSWORD = "447oYR6XensB7Wru"

local MQTT_HOSTNAME = "192.168.70.110"
local MQTT_PORT = 1883
local MQTT_USER = "boggart"
local MQTT_PASSWORD = "VbWrQLgz2yq7RMkA"
local MQTT_CLIENT_ID = wifi.sta.gethostname()
local MQTT_TOPIC = "/esp8266/"..string.gsub(wifi.sta.getmac(),":","-").."/"

local BME280_ALTITUDE=180
local SLEEP_INTERVAL=60 -- интервал между фиксациями показаний в секундах
