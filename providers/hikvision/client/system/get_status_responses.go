...
func (o *GetStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /System/status] getStatus", response, response.Code())
	}
}
...
func (o *GetStatusOK) Error() string {
	return fmt.Sprintf("[GET /System/status][%d] getStatusOK  %+v", 200, o.Payload)
}
...
func (o *GetStatusOK) GetPayload() *models.SystemStatus {
	return o.Payload
}
