...
// WithPhone adds the phone to the login params
func (o *LoginParams) WithPhone(phone string) *LoginParams {
	o.SetPhone(phone)
	return o
}

// SetPhone adds the phone to the login params
func (o *LoginParams) SetPhone(phone string) {
	o.Phone = phone
}
