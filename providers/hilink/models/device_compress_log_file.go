...
// ContextValidate validates this device compress log file based on context it is used
func (m *DeviceCompressLogFile) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
