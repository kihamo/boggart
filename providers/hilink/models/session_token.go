...
// ContextValidate validates this session token based on context it is used
func (m *SessionToken) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
