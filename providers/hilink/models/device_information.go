...
// ContextValidate validates this device information based on context it is used
func (m *DeviceInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
