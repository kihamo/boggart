...
/* GetUSSDStatusOK describes a response with status code 200, with default header values.
...
/* GetUSSDStatusDefault describes a response with status code -1, with default header values.
