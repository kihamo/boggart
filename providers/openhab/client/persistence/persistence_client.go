...
func (a *Client) HTTPDeletePersistenceServiceItem(params *HTTPDeletePersistenceServiceItemParams) (*HTTPDeletePersistenceServiceItemOK, error) {
	...
	success, ok := result.(*HTTPDeletePersistenceServiceItemOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for httpDeletePersistenceServiceItem: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) HTTPGetPersistenceItemData(params *HTTPGetPersistenceItemDataParams) (*HTTPGetPersistenceItemDataOK, error) {
	...
	success, ok := result.(*HTTPGetPersistenceItemDataOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for httpGetPersistenceItemData: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) HTTPGetPersistenceServiceItems(params *HTTPGetPersistenceServiceItemsParams) (*HTTPGetPersistenceServiceItemsOK, error) {
	...
	success, ok := result.(*HTTPGetPersistenceServiceItemsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for httpGetPersistenceServiceItems: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) HTTPGetPersistenceServices(params *HTTPGetPersistenceServicesParams) (*HTTPGetPersistenceServicesOK, error) {
	...
	success, ok := result.(*HTTPGetPersistenceServicesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for httpGetPersistenceServices: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) HTTPPutPersistenceItemData(params *HTTPPutPersistenceItemDataParams) (*HTTPPutPersistenceItemDataOK, error) {
	...
	success, ok := result.(*HTTPPutPersistenceItemDataOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for httpPutPersistenceItemData: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
