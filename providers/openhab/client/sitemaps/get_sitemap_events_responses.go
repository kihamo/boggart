...
func (o *GetSitemapEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetSitemapEventsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetSitemapEventsBadRequest creates a GetSitemapEventsBadRequest with default headers values
func NewGetSitemapEventsBadRequest() *GetSitemapEventsBadRequest {
...
*/
type GetSitemapEventsBadRequest struct {
}

func (o *GetSitemapEventsBadRequest) Error() string {
	return fmt.Sprintf("[GET /sitemaps/events/{subscriptionid}][%d] getSitemapEventsBadRequest ", 400)
}

func (o *GetSitemapEventsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
