...
// WithThingUID adds the thingUID to the delete params
func (o *DeleteParams) WithThingUID(thingUID string) *DeleteParams {
	o.SetThingUID(thingUID)
	return o
}

// SetThingUID adds the thingUid to the delete params
func (o *DeleteParams) SetThingUID(thingUID string) {
	o.ThingUID = thingUID
}
