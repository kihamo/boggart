...
func (m *UserInfo) contextValidateAccounts(ctx context.Context, formats strfmt.Registry) error {
...
// ContextValidate validates this user info accounts items0 based on context it is used
func (m *UserInfoAccountsItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
