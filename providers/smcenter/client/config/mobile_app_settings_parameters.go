...
func (o *MobileAppSettingsParams) WithTimeout(timeout time.Duration) *MobileAppSettingsParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the mobile app settings params
func (o *MobileAppSettingsParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the mobile app settings params
func (o *MobileAppSettingsParams) WithContext(ctx context.Context) *MobileAppSettingsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the mobile app settings params
func (o *MobileAppSettingsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the mobile app settings params
func (o *MobileAppSettingsParams) WithHTTPClient(client *http.Client) *MobileAppSettingsParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the mobile app settings params
func (o *MobileAppSettingsParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WriteToRequest writes these params to a swagger request
func (o *MobileAppSettingsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
