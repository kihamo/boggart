...
//go:generate /bin/bash -c "cd components/boggart/bind/esphome/native_api && go-bindata-assetfs -ignore='(.*?[.]po$)' -o ./bindata_assetfs.go -pkg=native_api -nometadata -nomemcopy templates/... locales/..."
