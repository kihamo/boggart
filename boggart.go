...
////go:generate /bin/bash -c "go install -v golang.org/x/tools/cmd/goimports@latest"
////go:generate /bin/bash -c "go install -v github.com/mailru/easyjson/...@latest"
////go:generate /bin/bash -c "go install -v github.com/dmarkham/enumer@latest"
////go:generate /bin/bash -c "go install -v github.com/go-swagger/go-swagger/cmd/swagger@latest"
...
//go:generate /bin/bash -c "echo 'Run go enumer'"
...
//go:generate /bin/bash -c "echo 'Run go tools (goimports)'"
