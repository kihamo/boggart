...
//go:generate /bin/bash -c "find components/boggart/bind/homie/locales/ -name \\*.po -execdir /bin/bash -c 'msgfmt {} -o `basename {} .po`.mo' '{}' \\;"
...
//go:generate /bin/bash -c "cd components/boggart/bind/homie && go-bindata-assetfs -ignore='(.*?[.]po$)' -o ./bindata_assetfs.go -pkg=homie -nometadata -nomemcopy templates/... locales/..."
