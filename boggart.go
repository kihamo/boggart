...
//go:generate /bin/bash -c "cd components/boggart && enumer -type=DeviceStatus -trimprefix=DeviceStatus -output=device_status_enumer.go"
...
//go:generate /bin/bash -c "easyjson components/boggart/internal/handlers/manager_index.go"
