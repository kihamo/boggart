...
//go:generate /bin/bash -c "find components/boggart/bind/esphome/locales/ -name \\*.po -execdir /bin/bash -c 'msgfmt {} -o `basename {} .po`.mo' '{}' \\;"
...
//go:generate /bin/bash -c "find components/ota/internal/locales/ -name \\*.po -execdir /bin/bash -c 'msgfmt {} -o `basename {} .po`.mo' '{}' \\;"
...
//go:generate /bin/bash -c "cd components/boggart/bind/esphome && go-bindata-assetfs -ignore='(.*?[.]po$)' -o ./bindata_assetfs.go -pkg=esphome -nometadata -nomemcopy templates/... locales/..."
...
//go:generate /bin/bash -c "cd components/boggart/bind/led_wifi && go-bindata-assetfs -ignore='(.*?[.]po$)' -o ./bindata_assetfs.go -pkg=led_wifi -nometadata -nomemcopy templates/... locales/..."
...
//go:generate /bin/bash -c "cd components/ota/internal && go-bindata-assetfs -ignore='(.*?[.]po$)' -o ./bindata_assetfs.go -pkg=internal -nometadata -nomemcopy assets/... templates/... locales/..."
