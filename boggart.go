...
//go:generate /bin/bash -c "cd components/boggart/bind/google_home && go-bindata-assetfs -ignore='(.*?[.]po$)' -o ./bindata_assetfs.go -pkg=google_home -nometadata -nomemcopy templates/..."
