...
//go:generate /bin/bash -c "cd components/boggart/bind/zigbee/z_stack && go-bindata-assetfs -ignore='(.*?[.]po$)' -o ./bindata_assetfs.go -pkg=z_stack -nometadata -nomemcopy templates/..."
